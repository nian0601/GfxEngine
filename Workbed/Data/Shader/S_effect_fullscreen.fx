...
technique11 Render
{
	pass P0
	{
		SetVertexShader(CompileShader(vs_5_0, VertexShader_FullscreenQuad()));
		SetGeometryShader(NULL);
		SetPixelShader(CompileShader(ps_5_0, PixelShader_FullscreenQuad()));
	}
}
...
technique11 Deferred_Ambient
{
	pass P0
	{
		SetVertexShader(CompileShader(vs_5_0, VertexShader_FullscreenQuad()));
		SetGeometryShader(NULL);
		SetPixelShader(CompileShader(ps_5_0, PixelShader_Deferred_Ambient()));
	}
}